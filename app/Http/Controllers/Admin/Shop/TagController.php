...
class TagController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $mostViewedTags = Tag::where('views', '>', $avg)->whereType('product')->inRandomOrder()->take(17)->get();


        return view('admin.store.tags.index', compact('tags', 'mostViewedTags'));
    ...
    public function store(Request $request)
    {
        try {
            ...
            $exists = Tag::whereName($name)->whereType('product')->first();
            ...
            setLog('Store-ShopTag', $e->getMessage(), 'danger');
        }
        return true;
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            $existingTag = Tag::where('name', $name)->whereType('product')->where('id', '!=', $id)->first();
            if ($existingTag) {
            ...
            setLog('Update-ShopTag', $e->getMessage(), 'danger');
            return redirect()->back();
        }
    }

<div>
    ...
    <div class=" mt-3">
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="form-floating col-12 mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="نام و نام خانوادگی مدیر">
        ...
        <div class="border rounded shadow-sm p-4 mt-3">
            ...
            <div class="container mt-3">
                ...
                <button type="button" class="btn btn-success d-block w-100" data-bs-toggle="modal" data-bs-target="#add-elevator">
                    <i class="fi-plus-circle me-1 fs-sm"></i>
                    ثبت آسانسور
                </button>

                <!-- Modal -->
                <div class="modal fade" id="add-elevator" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="form-floating col-12 mb-3">
                                        <select class="form-select custom-select-height-building "  aria-label="Default select example">
                                    ...
                                    <div class="form-floating col-12 mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="تاریخ نصب">
                                        <label for="floatingInput">تاریخ نصب</label>
                                    </div>

                                    <div class="form-floating col-12 mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="تاریخ آخرین بازرسی">
                                        <label for="floatingInput">تاریخ آخرین بازرسی</label>
                                    </div>

                                    <div class="form-floating col-12 mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="تاریخ تعمیر">
                                        <label for="floatingInput">تاریخ تعمیر</label>
                                    </div>

                                    <div class="form-floating col-12 mb-3">
                                        <select class="form-select custom-select-height-building" id="customSelect" aria-label="Default select example">
        ...
        مدل ممد 2
            ...
            <div class="container mt-2">
                <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start">
                    ...
                    <a class="collapse-label d-inline-block fs-md fw-bold text-success text-decoration-none pt-2 pb-3 mx-auto mx-md-0 ms-md-2 collapsed" href="#showMoreelevator" data-bs-toggle="collapse" data-bs-label-collapsed="آسانسور هاس ثبت شده" data-bs-label-expanded="بستن" role="button" aria-expanded="false" aria-controls="showMoreelevator">
    ...
    <div class="border rounded shadow-sm p-4 mt-3">
        ...
        <div class="container mt-3">
            ...
            <!-- Button trigger modal -->
            <button type="button" class="btn btn-success d-block w-100" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                <i class="fi-plus-circle me-1 fs-sm"></i>
                افزودن عضو
            </button>
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header ">
                            <h1 class="modal-title fs-5 bg-soft-success" id="staticBackdropLabel">افزودن اعضای ساختمان</h1>
                            <button type="button" class="btn-close me-0" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
       ...
       محمد اسدی
        ...
        <div class="container mt-2">
            <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start">
                ...
                <a class="collapse-label d-inline-block fs-md fw-bold text-success text-decoration-none pt-2 pb-3 mx-auto mx-md-0 ms-md-2 collapsed" href="#showMoreuser" data-bs-toggle="collapse" data-bs-label-collapsed="مشاهده اعضا" data-bs-label-expanded="بستن" role="button" aria-expanded="false" aria-controls="showMoreuser">
                    <i class="fi-arrow-down me-2"></i>
                </a>
            </div>
        </div>

<div class="card card-hover card-horizontal border-0 shadow-sm mb-4 mt-2">
    <div class="card-img-top position-relative" style="background-image: url({{ asset('assets/img/car-finder/catalog/16.jpg') }});"><a class="stretched-link"
                                                                                                                                       href="real-estate-single-v1.html"></a>
        <div class="position-absolute start-0 top-0 pt-3 ps-3"><span class="d-table badge bg-success mb-1">فعال</span><span class="d-table badge bg-info">جدید</span></div>
    ...
    <div class="card-body position-relative pb-3">
        ...
        <div class="d-flex align-items-center justify-content-center justify-content-sm-start border-top pt-3 pb-2 mt-3 text-nowrap"><span
                class="d-inline-block me-4 fs-sm">3<i class="fi-bed ms-1 mt-n1 fs-lg text-muted"></i></span><span class="d-inline-block me-4 fs-sm">2<i
                    class="fi-bath ms-1 mt-n1 fs-lg text-muted"></i></span><span class="d-inline-block fs-sm">2<i class="fi-car ms-1 mt-n1 fs-lg text-muted"></i></span></div>
    </div>
</div>

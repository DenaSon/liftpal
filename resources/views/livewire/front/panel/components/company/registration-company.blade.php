        ...
        <div class="card-body">
            ...
            <form wire:submit.debounce.1000ms="registerCompany">
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="manager_national_code" placeholder=""
                           wire:model="managerNationalCode">
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="economicCode" placeholder=""
                           wire:model="economicCode">
                    <label for="economicCode"> کد اقتصادی</label>
                </div>

                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="registrationCode" placeholder=""
                ...
                <div class="form-floating mb-3">
                    <input readonly data-jdp type="text" class="form-control" id="licenceExpire" placeholder=""
                           wire:model="licenceExpire">

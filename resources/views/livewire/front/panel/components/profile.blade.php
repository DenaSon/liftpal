    ...
    <div class="border rounded shadow-sm p-4">
        ...
        <div class="container mt-2">
            <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start">
                <a class="collapse-label collapsed d-inline-block fs-md fw-bold text-success text-decoration-none  pt-2 pb-3 mx-auto mx-md-0 ms-md-2" href="#showMoreSkill" data-bs-toggle="collapse"

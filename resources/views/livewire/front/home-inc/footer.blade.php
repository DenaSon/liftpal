...
<footer class="footer pt-5 ">
    <div class="container pt-lg-4 pb-4">
        ...
        <div class="row mb-5 pb-md-3 pb-lg-4">
            <div class="col-lg-6 mb-lg-0 mb-4">
                <div class="d-flex flex-sm-row flex-column justify-content-between mx-n2">
                    <div class="mb-sm-0 mb-4 px-2 ustify-content-center justify-content-md-start"><a class="d-inline-block mb-4" href="real-estate-home-v1.html"><img
                    ...
                    <div class="mb-sm-0 mb-4 px-2">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal" href="#">پیشنهادهای ویژه</a>
                            </li>
                            <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal" href="#">شهرهای پیشنهادی</a>
                            </li>
                        </ul>
                    </div>
                    <div class="px-2">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal" href="#">درباره ما</a></li>
                            <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal" href="#">نمایندگان ما</a></li>
                            <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal" href="#">مشاوره رایگان</a></li>
                            <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal" href="#">تماس با ما</a></li>
                            <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal" href="#">اخبار</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-xl-5 col-lg-6 offset-xl-1">
                ...
                <article class="d-flex align-items-start" style="max-width: 640px;"><a
                    ...
                    <div>
                        ...
                        <h5 class="mb-2 fs-base"><a class="nav-link" href="real-estate-blog-single.html">راهنمای ما برای
                                جستجوی آپارتمان هوشمند</a></h5>
                        <p class="mb-2 fs-sm">لورم ایپسوم ساختار چاپ و متن را در بر می گیرد. لورم ایپسوم استاندارد صنعت
                            بوده است...</p><a class="nav-link nav-link-muted d-inline-block me-3 p-0 fs-xs fw-normal"
                                              href="#"><i
                                class="fi-calendar mt-n1 me-1 fs-sm align-middle opacity-70"></i>24 خرداد</a><a
                            class="nav-link nav-link-muted d-inline-block me-3 p-0 fs-xs fw-normal" href="#"><i
                                class="fi-chat-circle mt-n1 me-1 fs-sm align-middle opacity-70"></i>2 کامنت</a>
                    </div>
                </article>
        ...
        <div class="bg-dark rounded-3">
            <div
                ...
                <img class="flex-shrink-0 mt-md-n5 me-md-5"
                     src="{{ asset('assets/img/real-estate/illustrations/mobile.svg') }}" width="240" alt="اپلیکیشن">
                <div
                    ...
                    <div class="me-md-5">
                        ...
                        <p class="mb-lg-0 text-light">همه چیزهایی را که برای خرید ، فروش اجاره ملک نیاز دارید در برنامه
                            Finder جدید ما پیدا کنید!</p>
                    </div>
                    <div class="flex-shrink-0"><a class="btn-market mx-2 ms-sm-0 ms-sm-4 mb-3" href="#" role="button">
        ...
        <div class="text-center fs-sm pt-4 mt-3 pb-2">&copy; تمام حقوق این سایت محفوظ است <a href=''

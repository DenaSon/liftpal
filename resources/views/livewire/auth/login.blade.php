    ...
    <div class="modal-body px-0 py-2 py-sm-0">
        ...
        <div class="row mx-0 align-items-center">
            <div class="col-md-6 border-end-md p-4 p-sm-5">
                <h2 class="h3 mb-4 mb-sm-5"><br>ورود به حساب کاربری {{ getSetting('website_title') }}</h2><img
                    class="d-block mx-auto rotate-img" src="{{ asset('assets/img/signin-modal/signin.svg') }}"
            ...
            <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                ...
                <button wire:click.throttle.4500ms="verifyPhoneNumber" class="btn btn-outline-info w-100 mb-3" href="#" id="sendSmsBtn">

                    <i class="fi-messenger fs-lg me-1">

                    </i>
                    ارسال کد یکبار مصرف  </button>



                <div class="input-group">

                    <input wire:model.live.debounce.1550ms="tempcode" id ="tempcode" class="form-control border-primary" type="number" placeholder="کد ارسال شده به تلفن همراه" maxlength="4" hidden="true">

...
@section('page-title', 'ویرایش  : محصول : '. $product->name . ' - '. $product->sku)
@section('CustomCss')
                        ...
                        <div id="progressbarwizard">
                            ...
                            <div class="tab-content b-0 mb-0 pt-0">
                                ...
                                <div id="bar" class="progress mb-3" style="height: 7px;">
                                    <div class="bar progress-bar   bg-primary" style="width: 100%;"></div>
                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <input min="0" type="number" class="form-control" id="reorder_level"
                                                           name="reorder_level" value="" placeholder="روز">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <input min="0" type="number" class="form-control" id="expire_alert"
                                                           name="expire_alert" value="" placeholder="روز">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row mb-3">
                                                <label class="col-md-3 col-form-label" for="entry_date">تاریخ ورود به
                                                    انبار </label>
                                                <div class="col-md-9">
                                                    <input dir="ltr" readonly data-jdp type="text" class="form-control"
                                                           id="entry_date"
                                                           name="entry_date">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <input dir="ltr" type="text" class="form-control"
                                                           id="drug_identification_number" name="din" value="">
                                                </div>
                                            </div>

        ...
        <div class="d-flex align-items-start mb-2">
            ...
            <div class="text-center">
                    ...
                    @if($user->orders->count() > 0)
                        ...
                        <p class="mb-3">{{ $user->orders->where('payment_status','paid')->count() }}  سفارش  <small class="text-muted"> پرداخت شده </small> </p>
                        @endif


                    <h4 class="font-13 text-muted text-uppercase mb-1"> موجودی کیف پول </h4>
                    <p class="mb-3">{{ number_format($user->wallet->balance) }}  هزار تومان </p>

...
<div class="card bg-pattern">
    <div class="card-body">
        <div class="row">
         ...
         {{\App\Models\User::where('role','visitor')->count('id') }}

    </span></h3>
                    <p class="text-muted mb-0 text-truncate">همکار</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-6">
                <div class="text-end">
                    <h3 class="text-dark my-1"><span data-plugin="counterup">
             {{\App\Models\User::where('role','author')->count('id') }}
    </span></h3>
                    <p class="text-muted mb-0 text-truncate"> نویسنده  </p>
                </div>
            </div>
        </div>
    </div>
...
<div class="card bg-pattern">
    ...
    <span data-plugin="counterup">
       {{\App\Models\User::where('role','stock')->count('id') }}
    </span> </h3>
                    <p class="text-muted mb-0 text-truncate">  انباردار </p>
                </div>
            </div>
        </div>
    </div>
                ...
                @foreach($users as $user)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if( $user->role == 'visitor') <span class="badge badge-outline-primary font-12"> همکار </span> @endif
                            @if( $user->role == 'author') <span class="badge badge-outline-warning font-12"> نویسنده </span> @endif
                            @if( $user->role == 'stock') <span class="badge badge-outline-blue font-12">  انباردار </span> @endif
